...
abstract class AppLocalizations {
  ...
  /// No description provided for @title_.
  ///
  /// In en, this message translates to:
  /// **'Title'**
  String get title_;
  ...
  /// No description provided for @valid_title.
  ///
  /// In en, this message translates to:
  /// **'Please Enter a valid Title'**
  String get valid_title;

  /// No description provided for @title_length.
  ///
  /// In en, this message translates to:
  /// **'Title should be at least a 3 characters'**
  String get title_length;

  /// No description provided for @valid_desc.
  ///
  /// In en, this message translates to:
  /// **'Please Enter a valid Description'**
  String get valid_desc;

  /// No description provided for @desc_length.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @task_insert.
  ///
  /// In en, this message translates to:
